...
Canonical source: `.ai/skills/features/packaging/`

Open `.ai/skills/features/packaging/SKILL.md` and any supporting files referenced there (for example `reference.md`, `examples.md`, `scripts/`, `templates/`).
